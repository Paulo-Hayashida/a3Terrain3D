...
void Window::onCreate() {
  // Load font with bigger size for de X's and O's
...
void Window::checkEndCondition() {
  ...
  // Lambda expression that checks if a string contains only Xs or Os. If
  // so, it changes de game state.to WinX or WinO accordingly and returns
